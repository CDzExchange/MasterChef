...
interface MasterChefInterface extends ethers.utils.Interface {
  functions: {
    ...
    "cdzMaxMint()": FunctionFragment;
    "cdzPerBlock()": FunctionFragment;
    "cdzTotalMinted()": FunctionFragment;
    "deposit(uint256,uint256)": FunctionFragment;
    "emergencyWithdraw(uint256)": FunctionFragment;
    "feeAddr()": FunctionFragment;
    "feeBlockLimit()": FunctionFragment;
    ...
    "setFeeBlockLimit(uint256)": FunctionFragment;
    "setMaxMint(uint256)": FunctionFragment;
    "setMigrator(address)": FunctionFragment;
    "startBlock()": FunctionFragment;
    "totalAllocPoint()": FunctionFragment;
    "transferCDZOwnership(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "cdzTotalMinted",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "feeBlockLimit",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setFeeBlockLimit",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "transferCDZOwnership",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "cdzMaxMint", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "cdzPerBlock",
    data: BytesLike
  ): Result;
...
export class MasterChef extends BaseContract {
  ...
  functions: {
    ...
    cdzMaxMint(overrides?: CallOverrides): Promise<[BigNumber]>;

    cdzPerBlock(overrides?: CallOverrides): Promise<[BigNumber]>;

    cdzTotalMinted(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    feeBlockLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    setFeeAddr(_addr: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    cdzMaxMint(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    cdzPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    cdzTotalMinted(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    feeBlockLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
